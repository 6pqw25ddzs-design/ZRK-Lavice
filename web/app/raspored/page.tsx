            ...
            return (
              <div key={e.id} style={{ backgroundColor: 'var(--card)', border: '1px solid var(--border)' }} className="rounded-xl p-5 flex gap-5 items-center">
                <div className="text-center min-w-[56px]">
                  <div className="text-3xl font-black text-white">{d.getDate()}</div>
                  <div style={{ color: 'var(--primary)' }} className="text-xs font-bold uppercase">{d.toLocaleString('sr-Latn-ME', { month: 'short' })}</div>
                </div>
                <div className="flex-1">
                  ...
                  <div style={{ color: 'var(--text-muted)' }} className="text-sm mt-1">
                    {d.toLocaleString('sr-Latn-ME', { weekday: 'long', hour: '2-digit', minute: '2-digit' })}
